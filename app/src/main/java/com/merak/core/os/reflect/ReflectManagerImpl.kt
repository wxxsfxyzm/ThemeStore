...
class ReflectManagerImpl : ReflectManager {
    ...
    override fun getConstructor(clazz: Class<*>, vararg parameterTypes: Class<*>): Constructor<*>? {
        ...
        return constructorCache.getOrPut(key) {
            try {
                ...
                Timber.Forest.w("Reflect: Constructor not found in ${clazz.name} with params ${parameterTypes.map { it.name }}")
                null
            }
        }
    }
    ...
    override fun getDeclaredConstructor(
        ...
        return constructorCache.getOrPut(key) {
            try {
                ...
                Timber.Forest.w("Reflect: Declared Constructor not found in ${clazz.name}")
                null
            }
        }
    }
    ...
    override fun getField(name: String, clazz: Class<*>): Field? {
        ...
        return fieldCache.getOrPut(key) {
            try {
                ...
                Timber.Forest.w("Reflect: Field '$name' not found in ${clazz.name}")
                null
            }
        }
    }
    ...
    override fun getMethod(
        ...
        return methodCache.getOrPut(key) {
            try {
                ...
                Timber.Forest.w("Reflect: Method '$name' not found in ${clazz.name}")
                null
            }
        }
    }
